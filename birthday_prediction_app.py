...
data = {
    ...
    'num_friends': np.random.randint(0, 500, 1000),
    'posts_last_month': np.random.randint(0, 50, 1000),
    'comments_last_month': np.random.randint(0, 100, 1000),
    'likes_last_month': np.random.randint(0, 200, 1000),
    'birthday_month': np.random.randint(1, 13, 1000),
    'birthday_day': np.random.randint(1, 32, 1000),
}
